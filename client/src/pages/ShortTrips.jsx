          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-4">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                ...
                <a
                  href={whatsappLink("Hello Mandyal Tour and Travels, I want to book a short trip from Una.")}
                  target="_blank"
            ...
            {filteredTrips.map((trip) => (
              ...
              >
                ...
                <div className="p-5 pt-0">
                  <a
                    href={whatsappLink(
                      `Hello Mandyal Tour and Travels, I want to book the "${trip.title}" (${trip.duration}) short trip.`
                    )}
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            {fleet.map((car) => (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col justify-between gap-3.5">
                  ...
                  <a
                    href={whatsappLink(`Hello Mandyal Tour and Travels, I want to book ${car.name} for a short trip.`)}
                    target="_blank"
                    rel="noopener noreferrer"
