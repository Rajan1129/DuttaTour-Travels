          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-4">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                ...
                <a
                  href={whatsappLink("Hello Dutta Travels, I need taxi pickup from Amb Andaura Railway Station (AADR).")}
                  target="_blank"
            ...
            {trainsServingAADR.map((train, idx) => (
              ...
              >
                ...
                <div className="pt-3 border-t border-gray-200/70 flex items-center justify-between text-xs">
                  ...
                  <a
                    href={whatsappLink(`Hello Dutta Travels, I need pickup for ${train.name} at Amb Andaura.`)}
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            {popularTransfers.map((item, idx) => (
              ...
              >
                ...
                <div className="pt-3 border-t border-gray-100 flex flex-col gap-2">
                  ...
                  <a
                    href={whatsappLink(
                      `Hello Dutta Travels, I need a taxi from Amb Andaura Railway Station to ${item.destination}. Please share the best rate.`
                    )}
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            {fleet.slice(0, 3).map((car) => (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col justify-between gap-3.5">
                  ...
                  <a
                    href={whatsappLink(`Hello Dutta Travels, I want to book ${car.name} at Amb Andaura Station.`)}
                    target="_blank"
                    rel="noopener noreferrer"
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
          <div className="bg-[#182030] text-white rounded-3xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-xs text-gray-300">
                  Avoid platform chaos and unreliable syndicates. Book guaranteed pickup with Dutta Tour &amp; Travel.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              ...
              <a
                href={whatsappLink("Hello Lavkush Dutta, I need platform pickup at Amb Andaura Station.")}
                target="_blank"
                rel="noopener noreferrer"
